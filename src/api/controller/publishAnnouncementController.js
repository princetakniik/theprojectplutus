...
const createPublishannounce = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ msg: "Insert publishannounce data", data: dataInsert });
  } catch (err) {
    console.log(err);
...
const getPublishannounce = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ msg: "get all publishannounce data", data: dataGet });
  } catch (err) {
    console.log(err);
...
const getByIdPublishannounce = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ msg: "get data by id publishannounce", data: dataGetById });
  } catch (err) {
    console.log(err);
...
const upatePublishannounce = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({
        msg: "publishannounce data update by id successfully",
        data: dataUpdate,
      });
  } catch (err) {
    console.log(err);
...
const deletePublishannounce = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({
        msg: "publishannounce data delete successfully",
        data: dataDelete,
      });
  } catch (err) {
    console.log(err);
