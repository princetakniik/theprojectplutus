...
const getByIdMakeannounce = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ msg: "get data by id makeAnnounce", data: dataGetById });
  } catch (err) {
    console.log(err);
...
const upateMakeannounce = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ msg: "data update by id successfully", data: dataUpdate });
  } catch (err) {
    console.log(err);
...
const deleteMakeannounce = async (req, res) => {
  ...
  try {
    ...
    res
      .status(200)
      .json({ msg: "makeAnnounce data delete successfully", data: dataDelete });
  } catch (err) {
    console.log(err);
